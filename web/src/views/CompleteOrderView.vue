      ...
      <div class="pt-4 pb-5 flex-col gap-y-4 border-b-[1px]">
        ...
        <div class="flex justify-between">
          <div class="flex flex-col pt-3">
            ...
            <span class="text-[18px] font-semibold text-blue-400">13 232 SenSok, Khmounh, Phnom Penh</span>
          </div>
        ...
        <div class="flex justify-between">
          <div class="flex flex-col pt-3 ">
            ...
            <span class="text-[18px] font-semibold text-blue-400">UPS Ground (Estimated ship around 3-6 days)</span>
          </div>
          <div class="flex flex-col pt-3 w-[30%]">
            ...
            <div class="flex">
              ...
              <span class="text-[18px] font-semibold text-blue-400">Ending in 3322 - 1003.65$</span>
            </div>
          </div>
        </div>
      </div>
